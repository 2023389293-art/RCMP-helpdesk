<?php
// uniKL/complaint/testing.php (login.php)
session_start();
...
/* If we had a POST error, auto-open the manual login panel */
$autoOpenManual = !empty($error) ? 'true' : 'false';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Sign In | UniKL RCMP Help Desk</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ── MAIN AREA ── */
    .main {
      min-height: calc(100vh - 38px - 76px - 52px);
    ...
    .btn-sso:hover { background: var(--navy-dark); transform: translateY(-1px); box-shadow: 0 6px 20px rgba(30,58,95,0.30); }
    .btn-sso:active { transform: translateY(0); }

    /* Microsoft logo 2×2 grid */
    ...
    .manual-panel.open { max-height: 420px; }
    ...
    .btn-submit {
      ...
      margin-top: 4px;
      transition: background .2s, transform .15s, box-shadow .2s;
      box-shadow: 0 3px 12px rgba(184,134,11,0.30);
    }
    .btn-submit:hover { background: var(--gold-light); transform: translateY(-1px); box-shadow: 0 6px 20px rgba(184,134,11,0.38); }
    ...
    @media (max-width: 640px) {
      ...
      .nav-back { font-size: 11px; padding: 7px 12px; }
      .main { padding: 24px 12px; }
      .card-body { padding: 30px 24px 24px; }
      .card-footer { padding: 14px 24px; }
      footer { padding: 0 16px; height: auto; padding-top: 10px; padding-bottom: 10px; flex-direction: column; gap: 8px; }
    }
  </style>
</head>
<body>
...
<div class="main">
  <div class="login-card">
    ...
    <div class="card-body">
      ...
      <div class="card-header">
        <div class="card-logo">
          ...
          <div class="card-logo-text">
            ...
            <div class="card-logo-name">Help Desk System</div>
          </div>
        </div>
        <h1>Welcome <em>Back</em></h1>
        <p>Sign in to submit and track your service requests.</p>
      </div>

      <div class="card-divider"></div>

      <!-- ── PRIMARY: Microsoft SSO ── -->
      <a href="auth/sso_login.php" class="btn-sso">
      ...
      <p class="sso-note">Use your UniKL Microsoft account — recommended for all staff and students.</p>
      ...
      <!-- ── SECONDARY: Manual email/password ── -->
    ...
    <div class="card-footer">
      ...
      Need help? Contact ITD Ext.&nbsp;<a href="tel:+60000000142"><strong>142</strong></a>&nbsp;/&nbsp;<a href="tel:+60000000140"><strong>140</strong></a>
    </div>
...
<script>
  ...
  const autoOpen    = <?php echo $autoOpenManual; ?>;
  ...
  /* Auto-open if there was a POST error */
