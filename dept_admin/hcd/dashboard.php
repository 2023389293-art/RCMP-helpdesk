...
$r = $conn->query("SELECT priority, COUNT(*) AS n FROM complaints WHERE dept_id = 5 GROUP BY priority");
...
$openTickets = $conn->query("
    ...
    FROM complaints
    WHERE dept_id = 5 AND status = 'open'
...
<head>
  ...
  <title>Human Capital Department Admin — Dashboard | UniKL Help Desk</title>
...
<main class="main-content">
  ...
  <div class="dash-header">
    <div>
      <div class="dash-eyebrow">HCD · Admin Panel</div>
