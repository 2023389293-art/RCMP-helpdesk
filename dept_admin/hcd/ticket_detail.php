...
$dsStmt = $conn->prepare("
    ...
    FROM staff
    WHERE dept_id = 5 AND status = 'active' AND role = 'staff'
    ...
    <div class="detail-tab-grid">
      ...
      <div class="detail-right">
        ...
        <div class="admin-view-notice">
          <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
          <div>You are viewing as <strong>Admin</strong>. Priority and status changes can only be made by the assigned staff.</div>
        </div>
  ...
  <div class="td-panel <?= $activeTab === 'conversation' ? 'active' : '' ?>">
    <div class="conv-card">
      ...
      <div class="conv-readonly-bar">
        <svg viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        You do not have permission to reply. Contact Human Capital Department staff for updates.
      </div>
