...
<a class="sidebar-brand" href="../../index.php">
  ...
  <div class="sidebar-dept">
    <div class="dept-chip">
      ...
      <?= $_SESSION['staff_role'] === 'hod' ? 'HOD AFSMD' : 'Admin AFSMD' ?>
    </div>
  </div>
...
<?php /* Manage Vendors — not used yet for AFSMD, enable later
echo nav_item('vendors.php',
  ...
  'Manage Vendors', 'vendors', $currentPage); */ ?>
    ...
    <div class="nav-group <?= $reportsOpen ?>">
      ...
      <div class="nav-submenu nav-group-submenu">
        ...
        <!-- Vendor Activity — not used yet for AFSMD, enable later
        <a href="reports.php?tab=vendors" class="nav-subitem <?= (($_GET['tab'] ?? '') === 'vendors') ? 'active' : '' ?>">
          <svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>
          Vendor Activity
        </a>
        -->
        <a href="reports.php?tab=feedback" class="nav-subitem <?= (($_GET['tab'] ?? '') === 'feedback') ? 'active' : '' ?>">
