/* =============================================================
   category-report.js  —  Afsmd Dept Admin · Category Tab 
...
(function () {
  ...
  window.catDownloadPDF = async function () {
    ...
    doc.setFontSize(12);
    doc.text('UniKL Help Desk — Administration & Facilities Management Department | Category Report', 36, 10);
    doc.setFontSize(8);
  ...
  return t > 0 ? (c/t*100) : 0;
    ...
    for (let i=1;i<=pc;i++) {
      ...
      doc.text(`Page ${i} of ${pc} — UniKL Help Desk — AFSMD`, 14, 208);
    }
