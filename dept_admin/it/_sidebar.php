...
<a class="sidebar-brand" href="../../index.php">
  ...
  <div class="brand-text">
    <div class="t1" style="font-size:14px;">UniKL RCMP</div>
    <div class="t2" style="font-size:17px;">Help Desk</div>
  </div>
</a>
  ...
  <div class="sidebar-footer">
    <div class="user-info">
      ...
      <div style="flex:1; min-width:0;">
        ...
        <div class="user-role">Dept Admin · IT</div>
      </div>
