<?php
// dept_admin/maintenance/_layout.php
// Shared layout helpers for Maintenance Admin pages

if (session_status() === PHP_SESSION_NONE) session_start();

// Auth guard
if (empty($_SESSION['staff_id']) || $_SESSION['dept_folder'] !== 'maintenance' || !in_array($_SESSION['staff_role'], ['admin', 'hod'])) {
