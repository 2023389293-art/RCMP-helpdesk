...
$r = $conn->query("SELECT priority, COUNT(*) AS n FROM complaints WHERE dept_id = 3 GROUP BY priority");
...
$openTickets = $conn->query("
    ...
    FROM complaints
    WHERE dept_id = 3 AND status = 'open'
...
<main class="main-content">
  ...
  <div class="dash-header">
    <div>
      <div class="dash-eyebrow">CCU · Admin Panel</div>
      <h1 class="dash-h1">CCU Department <span class="accent">Dashboard</span></h1>
    </div>
