/* =============================================================
   feedback-report.js  —  CCU Dept Admin · Feedback Tab
...
(function () {
  ...
  window.fbDownloadPDF = async function () {
    ...
    doc.setFontSize(12);
    doc.text('UniKL Help Desk — Corporate Communication Unit | Feedback Report', 36, 10);
    doc.setFontSize(8);
    ...
    for (let i = 1; i <= pc; i++) {
      ...
      doc.setFontSize(7);
      doc.setTextColor(148, 163, 184);
      doc.text(`Page ${i} of ${pc}  —  UniKL Help Desk CCU  —  Feedback Report`, 14, 203);    }
