...
<head>
  ...
  <style>
    ...
    .usage-some{background:#EDE9FE;color:#5B21B6}
    ...
    .form-input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(124,58,237,.08)}
    ...
    .btn-stay-modal:hover{background:#5B21B6}
        ...
        <div class="tbl-card">
          <div class="card-header">
            <div class="card-header-left">
              ...
              <div>
                <div class="card-header-title">CCU Categories</div>
        ...
        <div class="card" id="formCard">
          ...
          <div class="card-body">
            ...
            <form method="POST" action="categories.php" id="catForm">
              ...
              <div class="form-hint" id="formHint">Only type the topic — <em>CCU /</em> is added automatically.</div>
...
function startEdit(id, fullName) {
  ...
  // Hide prefix span and make input full-width rounded during edit
  document.getElementById('ccuPrefix').style.display         = 'none';
...
function forceCancelEdit() {
  ...
  // Restore prefix and hint
  document.getElementById('ccuPrefix').style.display         = 'flex';
