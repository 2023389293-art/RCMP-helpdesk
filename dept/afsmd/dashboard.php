...
// ── Layout variables ──────────────────────────────────────────────────────────
$activeNav    = 'dashboard';
$pageTitle    = 'Administration & Facilities Management';
...
<head>
  ...
  <title>Dashboard | UniKL Help Desk – AFSMD</title>
...
.topdept-bar {
  ...
  border-radius: 99px; transition: width 0.5s ease;
    ...
    .mytask-item {
      ...
      background: #F0F4FF; border: 1px solid #C7D9F0;
    ...
    .mt-tid { font-size: 11px; font-weight: 600; color: #5B8CCC; font-family: monospace; }
...
.mt-sla-soon    { background: #FEF3C7; color: #D97706; }
    ...
    .staff-avatar-sm {
      ...
      height: 32px;
      border-radius: 50%;
      background: linear-gradient(135deg, #1a2f5e, #5B8CCC);
      color: white;
      display: flex;
      align-items: center;
...
.tab-btn.active { color: #5B8CCC; border-bottom-color: #5B8CCC; }
...
.tab-btn.active .tab-count { background: #EEF4FF; color: #5B8CCC; }
...
@media (max-width: 640px) {
  ...
  table tbody td:nth-child(3) { display: none; } /* Complaint By */
  table thead th:nth-child(5),
  table tbody td:nth-child(5) { display: none; } /* Priority */
  table thead th:nth-child(6),
  table tbody td:nth-child(6) { display: none; } /* Category */
...
<div class="card-box" style="flex:1; min-width:0; display:flex; flex-direction:column;">
  ...
  <div style="flex:1; display:flex; flex-direction:row; align-items:center; justify-content:center; gap:20px;">
    ...
    <div style="display:flex; flex-direction:column; gap:8px; flex:1; min-width:0; max-width:280px;">
      <?php
        $pieColors = ['#5B8CCC','#7C3AED','#DB2777','#D97706','#059669'];
