...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif ($action === 'edit') {
        ...
        $suffix = trim($_POST['category_name'] ?? '');
$suffix = trim(preg_replace('/^(AFSMD\s*\/\s*)+/i', '', $suffix));
$name   = $suffix !== '' ? 'AFSMD / ' . $suffix : '';
        if (!$id || empty($suffix)) {
...
<head>
  ...
  <title>Categories | UniKL Help Desk – AFSMD</title>
        ...
        <div class="tbl-card">
          <div class="card-header">
            <div class="card-header-left">
              ...
              <div>
                <div class="card-header-title">AFSMD Categories</div>
            ...
            <table id="cat-table">
              ...
              <tbody id="cat-tbody">
                ...
                <tr data-name="<?php echo strtolower(htmlspecialchars($cat['category_name'])); ?>">
                  ...
                  <td>
                    <div class="cat-name"><?php echo htmlspecialchars(preg_replace('/^AFSMD\s*\/\s*/i', '', $cat['category_name'])); ?></div>
                  </td>
                  <td>
...
function startEdit(id, fullName) {
  var suffix = fullName.replace(/^(AFSMD\s*\/\s*)+/i, '').trim();
