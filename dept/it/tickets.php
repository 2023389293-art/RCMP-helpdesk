  ...
  <a href="<?php echo ticketUrl(['status'=>'closed','page'=>1]); ?>" class="filter-tab tab-closed <?php echo $filterStatus==='closed'?'active':''; ?>"><span class="tab-dot tab-dot-closed"></span>Closed <span class="ft-count"><?php echo $closedCount; ?></span></a>
    ...
    <div class="toolbar">
      <div class="toolbar-left">
        <?php
          if ($filterStatus === 'open') { $secTitle = 'Open Tickets'; }
          elseif ($filterStatus === 'in_progress') { $secTitle = 'In Progress Tickets'; }
          elseif ($filterStatus === 'closed') { $secTitle = 'Closed Tickets'; }
          else { $secTitle = 'All Tickets'; }
        ?>
        <span class="sec-title"><?php echo $secTitle; ?></span>
