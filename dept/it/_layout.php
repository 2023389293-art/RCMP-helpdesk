  ...
  <div class="sb-brand">
    <a class="brand-logo" href="dashboard.php">
      ...
      <div class="brand-text">
        ...
        <div class="bot">IT Department</div>
      </div>
    </a>
  </div>
...
<!-- ═══════════════════════════════════════════════════
     ...
     API is at: /uniKL/complaint/new_ticket_popup_api.php
     ═══════════════════════════════════════════════════ -->
<script>
(function () {
  'use strict';

  var POPUP_API  = window.location.protocol + '//' + window.location.host + '/uniKL/complaint/new_ticket_popup_api.php';
  ...
  function showToast(data) {
    ...
    /* Cap total visible toasts — remove oldest if at limit */
