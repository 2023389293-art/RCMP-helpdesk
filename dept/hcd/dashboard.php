...
// ── Layout variables ──────────────────────────────────────────────────────────
$activeNav    = 'dashboard';
$pageTitle    = 'Human Capital Department';
...
<head>
  ...
  <title>Dashboard | UniKL Help Desk – HCD</title>
...
foreach ($topDepts as $d) {
    $labelParts[] = json_encode($d['my_department'] ?? '—');
}
?>
const labels = [<?php echo implode(',', $labelParts); ?>];
