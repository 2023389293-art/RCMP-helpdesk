...
<head>
  ...
  <title>All Tickets | UniKL Help Desk – PMTC</title>
  ...
  <style>
    ...
    .tid-link:hover{color:#047857;text-decoration:underline}
    ...
    .bdg-open{background:#D1FAE5;color:#059669}
    .bdg-closed{background:#DCFCE7;color:#16A34A}
...
.tab-dot-open{background:#F59E0B;}
.tab-dot-inprogress{background:#3B82F6;}
.tab-dot-closed{background:#10B981;}
.filter-tab.active .tab-dot{background:rgba(255,255,255,.75);}

.bdg-in_progress{background:#DBEAFE;color:#1D4ED8;}

.active-filter-banner{display:flex;align-items:center;gap:10px;padding:10px 16px;border-radius:10px;margin-bottom:14px;font-size:13px;font-weight:500;}
.banner-open{background:#FFFBEB;color:#92400E;border:1px solid #FDE68A;}
.banner-closed{background:#ECFDF5;color:#065F46;border:1px solid #A7F3D0;}
.banner-inprogress{background:#EFF6FF;color:#1E40AF;border:1px solid #BFDBFE;}
.banner-dot{width:8px;height:8px;border-radius:50%;flex-shrink:0;}
.banner-open .banner-dot{background:#F59E0B;}
.banner-closed .banner-dot{background:#10B981;}
.banner-inprogress .banner-dot{background:#3B82F6;}
.banner-clear{margin-left:auto;font-size:12px;font-weight:500;color:inherit;text-decoration:none;opacity:.7;padding:2px 8px;border-radius:5px;border:1px solid currentColor;}
.priority-pill{display:inline-flex;align-items:center;gap:4px;font-size:.75rem;font-weight:800;letter-spacing:.07em;text-transform:uppercase;white-space:nowrap;}
...
<?php require_once __DIR__ . '/_layout.php'; ?>
    ...
    <div class="filter-bar">
      ...
      <a href="<?php echo ticketUrl(['status'=>'open','page'=>1]); ?>" class="filter-tab <?php echo $filterStatus==='open'?'active':''; ?>">
        <span class="tab-dot tab-dot-open"></span>Open <span class="ft-count"><?php echo $openCount; ?></span>
      </a>
      <a href="<?php echo ticketUrl(['status'=>'in_progress','page'=>1]); ?>" class="filter-tab <?php echo $filterStatus==='in_progress'?'active':''; ?>">
      ...
      <a href="<?php echo ticketUrl(['status'=>'closed','page'=>1]); ?>" class="filter-tab <?php echo $filterStatus==='closed'?'active':''; ?>">
        <span class="tab-dot tab-dot-closed"></span>Closed <span class="ft-count"><?php echo $closedCount; ?></span>
      </a>
    </div>
    <!-- Status banner -->
    <?php if ($filterStatus==='open'): ?>
    <div class="active-filter-banner banner-open"><span class="banner-dot"></span>Showing <strong><?php echo $openCount; ?> open</strong> tickets<a href="<?php echo ticketUrl(['status'=>'all','page'=>1]); ?>" class="banner-clear">Clear</a></div>
    <?php elseif ($filterStatus==='in_progress'): ?>
    <div class="active-filter-banner banner-inprogress"><span class="banner-dot"></span>Showing <strong><?php echo $inProgressCount; ?> in progress</strong> tickets<a href="<?php echo ticketUrl(['status'=>'all','page'=>1]); ?>" class="banner-clear">Clear</a></div>
    <?php elseif ($filterStatus==='closed'): ?>
    <div class="active-filter-banner banner-closed"><span class="banner-dot"></span>Showing <strong><?php echo $closedCount; ?> closed</strong> tickets<a href="<?php echo ticketUrl(['status'=>'all','page'=>1]); ?>" class="banner-clear">Clear</a></div>
    <?php endif; ?>
          ...
          <tbody id="ticket-tbody">
            ...
            >
              ...
              <td>
                ...
                ?>
                <span style="font-size:14px;font-weight:500;color:var(--g700);" title="<?php echo htmlspecialchars($t['category_name']); ?>">
              ...
              <td>
                ...
                <div style="display:flex;align-items:center;gap:7px;">
                  ...
                  <span style="font-size:13px;color:var(--g700);font-weight:500;">
