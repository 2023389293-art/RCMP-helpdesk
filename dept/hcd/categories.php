...
<head>
  ...
  <title>Categories | UniKL Help Desk – PMTC</title>
  ...
  <style>
    ...
    .cat-id{font-family:monospace;font-size:11px;color:var(--g400);margin-top:2px}
    ...
    .usage-some{background:#D1FAE5;color:#065F46}
    ...
    .form-input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(5,150,105,.08)}
    ...
    /* Glow on the form card when in edit mode */
    ...
    .btn-stay-modal:hover{background:#047857}
        ...
        <div class="tbl-card">
          <div class="card-header">
            <div class="card-header-left">
              ...
              <div>
                <div class="card-header-title">PMTC Categories</div>
              ...
              <tbody id="cat-tbody">
                ...
                <tr data-name="<?php echo strtolower(htmlspecialchars($cat['category_name'])); ?>">
                  ...
                  <td>
                    ...
                    <div class="cat-id">ID: <?php echo $cat['category_id']; ?></div>
                  </td>
                  <td>
        ...
        <div class="card" id="formCard">
          ...
          <div class="card-body">
            ...
            <form method="POST" action="categories.php" id="catForm">
              ...
              <div class="form-hint" id="formHint">Only type the topic — <em>PMTC /</em> is added automatically.</div>
...
document.addEventListener('DOMContentLoaded', function () {
  // Adjust the selector below to match your layout's nav links if needed
...
// ─── Catch browser tab close / page refresh while editing ────────────────────
...
function startEdit(id, fullName) {
  ...
  document.getElementById('pmtcPrefix').style.display         = 'none';
...
function forceCancelEdit() {
  ...
  document.getElementById('pmtcPrefix').style.display         = 'flex';
  document.getElementById('category_name').style.borderRadius = '0 9px 9px 0';
...
// Clicking the backdrop closes it (stays on page)
